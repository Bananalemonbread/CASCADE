...
from cascade.analysis.visualizer.TreeVisualizer import TreeVisualizer
...
class TreeAnalysis(Analysis):
    ...
    TODO
    """
    def __init__(self, generator: Generation, executor: Execution, visualizer: Visualization = None, regenerate=False, reexecute=False, debug=0, step_size=1, die_if_setup_fails=False, no_original_tests=False):
        ...
        self.debug = debug
        self.visualizer = visualizer or Visualization(TreeVisualizer())
